...
export default function ChatBot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Hello! I'm the MASTMO AI. Ask me anything about the club! ♾️",
    },
  ]);
            ...
            >
              ...
              {isLoading && (
                <div className="flex gap-2">
                  <div className="p-2 bg-[#FFD700]/20 text-[#FFD700] rounded-full h-8 w-8 flex items-center justify-center">
                    <Bot size={14} />
                  </div>
