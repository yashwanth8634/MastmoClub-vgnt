...
export default function TeamCard({ member }: { member: TeamMemberProps }) {
  ...
  return (
    <div className="group relative bg-white/5 border border-white/10 rounded-xl p-6 hover:border-[#00f0ff]/50 transition-all duration-300 hover:-translate-y-1 flex flex-col items-center text-center">
