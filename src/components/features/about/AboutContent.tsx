...
export default function AboutContent() {
  return (
    <main className="relative min-h-screen bg-transparent font-sans text-white selection:bg-math-cyan/30">
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20">
        ...
        <div className="text-center mb-24">
          <motion.div
            ...
            className="inline-block mb-6 px-4 py-1 rounded-full border border-math-cyan/30 bg-math-cyan/10"
          >
            <span className="text-math-cyan text-xs font-bold tracking-[0.2em] uppercase">
              Our Mission
            </span>
          </motion.div>
          ...
          >
            The Mathematical <br />
            <span className="text-math-cyan">Engine of Modern AI</span>
          </motion.h1>
          ...
          >
            Data Science and Engineering problems are increasingly solved using
            models that simulate real-world phenomena.
            <strong className="text-gray-100"> MASTMO</strong> exists to master
            the mathematics that underpins these technologies.
          </motion.p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-transparent">
            {VISIONARIES.map((person, i) => (
              <motion.div
                ...
                className="relative p-8 rounded-2xl bg-linear-to-br from-white/5 to-black border border-white/40 hover:border-math-cyan/30 transition-all duration-300 bg-black"
              >
                <Quote className="text-math-cyan mb-4 opacity-50" size={24} />
                <h3 className="text-xl font-bold text-white mb-1">
                  {person.name}
                </h3>
                <p className="text-xs font-bold text-math-cyan uppercase tracking-widest mb-4">
                  {person.role}
                </p>
        ...
        >
          <div className="bg-black border border-white/40 p-10 rounded-3xl backdrop-blur-sm">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Most engineering curricula emphasize theory without sufficient
              application. We bridge that gap. Whether it is structural
              analysis, machine learning, or operations research,
              <strong> mathematics is the universal language.</strong>
            </p>
            <div className="flex flex-col gap-4">
              {THEMES.map((theme, i) => (
                <div key={i} className="pl-4 border-l-3 border-math-cyan">
          ...
          <div className="relative h-full min-h-[400px] rounded-3xl overflow-hidden border border-white/40 bg-black/50 flex items-center justify-center">
            <div className="absolute inset-0 bg-linear-to-br from-math-cyan/20 to-purple-500/20 blur-3xl"></div>
            <div className="relative text-center p-8">
              <Globe
                size={64}
                className="text-math-cyan mx-auto mb-6 opacity-80"
              />
              <h3 className="text-2xl font-bold mb-2">From Theory</h3>
              <div className="w-0.5 h-8 bg-white mx-auto my-2"></div>
              <h3 className="text-2xl font-bold text-math-cyan">
                To Application
              </h3>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 bg-transparent">
            {OBJECTIVES.map((obj, i) => (
              ...
              >
                <obj.icon
                  className="text-gray-500 group-hover:text-math-cyan mb-6 transition-colors"
                  size={32}
                />
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-32 text-center p-12 rounded-3xl bg-linear-to-b from-white/5 to-transparent border border-white/40 bg-black"
        >
          <h2 className="text-4xl font-bold mb-6">
            Ready to solve the impossible?
          </h2>
          <p className="text-gray-300 mb-8 max-w-xl mx-auto">
            Join a community of thinkers, builders, and innovators. The future
            is written in code, but defined by math.
          </p>
          <Link
            href="/join"
            className="inline-flex items-center gap-2 px-10 py-4 bg-math-cyan text-black font-bold rounded-full hover:bg-white transition-all duration-300"
          >
