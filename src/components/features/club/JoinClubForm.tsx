      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex p-1 bg-white/5 rounded-2xl mb-8 border border-white/10">
          <button 
            ...
            className={`flex-1 py-3 rounded-xl flex items-center justify-center gap-2 font-bold transition-all cursor-pointer ${activeTab === "student" ? "bg-[#00f0ff] text-black shadow-lg" : "text-gray-400 hover:text-white"}`}
          >
            <User size={18} /> Student
          </button>
          <button 
            onClick={() => { setActiveTab("faculty"); setStatus(null); }}
            className={`flex-1 py-3 rounded-xl flex items-center justify-center gap-2 font-bold transition-all cursor-pointer ${activeTab === "faculty" ? "bg-[#00f0ff] text-black shadow-lg" : "text-gray-400 hover:text-white"}`}
          >
        ...
        <div className="bg-white/5 border border-white/10 rounded-3xl p-6 md:p-8 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 key={activeTab}">
            ...
            <button 
              ...
              className={`w-full py-4 font-bold rounded-xl transition-all flex justify-center items-center gap-2 cursor-pointer ${
                isSubmitting 
