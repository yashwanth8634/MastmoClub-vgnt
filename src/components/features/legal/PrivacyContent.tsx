            ...
            <div className="bg-[#0a0a0a] border border-white/10 rounded-2xl p-8 space-y-8">
              ...
              <div>
                ...
                <ul className="text-gray-300 space-y-2 ml-4 border-l-2 border-[#00f0ff]/20 pl-4">
                  ...
                  <li>• <strong>Anonymous Browser ID:</strong> A randomly generated identifier stored in your browser to prevent spam and enable rate limiting. This ID is not linked to your personal identity.</li>
                </ul>
              </div>
