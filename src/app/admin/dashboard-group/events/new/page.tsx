...
import { Plus, ArrowLeft, Loader2, CalendarClock, Users, MapPin } from "lucide-react";
      ...
      <form action={handleSubmit} className="space-y-8">
        ...
        <div className="p-6 bg-white/5 border border-white/10 rounded-2xl space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                    ...
                    <input name="title" placeholder="e.g. Code-a-thon 2025" required className="w-full bg-black border border-white/10 rounded-xl p-4 text-white focus:border-[#00f0ff] outline-none" />
                </div>
                <div className="space-y-2">
                    <label className="text-xs font-bold uppercase text-gray-500">Category</label>
                    <select name="category" className="w-full bg-black border border-white/10 rounded-xl p-4 text-white focus:border-[#00f0ff] outline-none">
            ...
            <div className="space-y-2">
                ...
                <textarea name="description" placeholder="Describe the event..." rows={4} required className="w-full bg-black border border-white/10 rounded-xl p-4 text-white focus:border-[#00f0ff] outline-none" />
            </div>
        </div>
        ...
        <div className="p-6 bg-white/5 border border-white/10 rounded-2xl space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                    ...
                    <input name="time" placeholder="e.g. 10:00 AM" required className="w-full bg-black border border-white/10 rounded-xl p-4 text-white focus:border-[#00f0ff] outline-none" />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <input name="location" placeholder="e.g. Main Auditorium" required className="w-full bg-black border border-white/10 rounded-xl p-4 pl-12 text-white focus:border-[#00f0ff] outline-none" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="p-6 bg-white/5 border border-white/10 rounded-2xl space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                    ...
                    />
                    <p className="text-[10px] text-gray-500">Registration closes automatically after this time.</p>
                </div>
        ...
        <div className="p-6 bg-white/5 border border-white/10 rounded-2xl space-y-4">
            ...
            <div className="flex items-center gap-3 mb-4 p-3 bg-black/40 rounded-lg border border-white/5">
                <input type="checkbox" name="isTeamEvent" id="isTeam" className="w-5 h-5 accent-[#00f0ff]" />
            ...
            <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                    ...
                    <input type="number" name="minTeamSize" defaultValue={1} min="1" className="w-full bg-black border border-white/10 rounded-xl p-4 text-white focus:border-[#00f0ff] outline-none" />
                </div>
                <div className="space-y-2">
                    <label className="text-xs font-bold uppercase text-gray-500">Max Members</label>
                    <input type="number" name="maxTeamSize" defaultValue={1} min="1" className="w-full bg-black border border-white/10 rounded-xl p-4 text-white focus:border-[#00f0ff] outline-none" />
                </div>
            </div>
        </div>
        ...
        >
          {isSubmitting ? (
            <>
              <Loader2 className="animate-spin" size={20} /> Creating Event...
            </>
          ) : (
            <>
